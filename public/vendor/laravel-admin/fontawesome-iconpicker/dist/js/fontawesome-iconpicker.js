...
(function(e) {
    ...
    (function() {
        var r, y = Math.max, x = Math.abs, s = /left|center|right/, i = /top|center|bottom/, f = /[\+\-]\d+(\.[\d]+)?%?/, l = /^\w+/, c = /%$/, a = z.fn.pos;
        function q(e, a, t) {
        ...
        z.pos = {
            scrollbarWidth: function() {
                ...
                var e, a, t = z("<div " + "style='display:block;position:absolute;width:50px;height:50px;overflow:hidden;'>" + "<div style='height:100px;width:auto;'></div></div>"), s = t.children()[0];
                z("body").append(t);
                e = s.offsetWidth;
            ...
            getScrollInfo: function(e) {
                ...
                return {
                    width: r ? z.pos.scrollbarWidth() : 0,
                    height: s ? z.pos.scrollbarWidth() : 0
                };
            },
            getWithinInfo: function(e) {
                var a = z(e || window), t = z.isWindow(a[0]), s = !!a[0] && a[0].nodeType === 9, r = !t && !s;
                return {
                    element: a,
                    isWindow: t,
                    isDocument: s,
        ...
        z.fn.pos = function(h) {
            ...
            h = z.extend({}, h);
            var m, p, d, u, T, e, g = z(h.of), b = z.pos.getWithinInfo(h.within), k = z.pos.getScrollInfo(b), w = (h.collision || "flip").split(" "), v = {};
            e = t(g);
            ...
            return this.each(function() {
                var t, e, f = z(this), l = f.outerWidth(), c = f.outerHeight(), a = j(this, "marginLeft"), s = j(this, "marginTop"), r = l + a + j(this, "marginRight") + k.width, i = c + s + j(this, "marginBottom") + k.height, o = z.extend({}, T), n = q(v.my, f.outerWidth(), f.outerHeight());
                if (h.my[0] === "right") {
                    o.left -= l;
        ...
        (function() {
            ...
            s = z(f).offset().left;
            z.support.offsetFractions = s > 10 && s < 11;
            e.innerHTML = "";
            a.removeChild(e);
        })();
    })();
...
(function(e) {
    ...
    t.defaultOptions = c.extend(t.defaultOptions, {
        icons: [ {
            ...
            title: "fab fa-apple",
            searchTerms: [ "food", "fruit", "ios", "mac", "operating system", "os", "osx" ]
        }, {
